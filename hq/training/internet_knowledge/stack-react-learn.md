...
function AboutPage() {
  ...
  return (
      ...
      pHello there.br />How do you do?</p
...
In React, there is no special syntax for writing conditions. Instead, you’ll use the same techniques as you use when writing regular JavaScript code. For example, you can use an statement to conditionally include JSX:
...
export default function MyApp() {
  return (
    div
      h1Counters that update separately</h1
      MyButton />
      MyButton />
    </div
  );
...
export default function MyApp() {
  ...
  return (
    ...
    div
      ...
      h1Counters that update together</h1
