...
> **15 rooms · 109 agents · 16 binding laws · 9 gates · an S1→S6 production line.**
>
...
| **Agents** | 109 specialist agents defined as Markdown specs in `.opencode/agent/` |
...
| 03 | Design | `dsn-lead` | UX flows, design systems, mockups |
| 04 | Architecture | `arc-lead` | DDD architecture, API contracts, review |
...
│   │   │   ├── registry.yaml             # ⭐ official registry: 15 rooms · 109 agents
...
│   ├── agent/*.md             # 109 agent definitions (legal spec source)
...
| 12 | Registry Invariant | `registry.yaml` must always match reality (15 rooms · 109 agents) |
...
python3 hq/core/tooling/count_sync.py    # verify counts match the registry (109 expected)
```
...
6. **The registry is law** — 15 rooms · 109 agents must always reconcile (Law 12).
