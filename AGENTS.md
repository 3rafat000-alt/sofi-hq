...
`hq/core/nexus/registry.yaml` is the official registry of 14 rooms · 108 agents. Any generation or migration must match it or fail loudly. Capsules in `hq/core/domain/rooms/` respect their capability limits.
...
- **14 rooms** · **108 active agents** · **26 standards** · **~96/100 audit score**
- Last updated: **2026-09-04 (R3.1)** — Laws 1–16 + Stack Lock + Room Priority v2 + Room 04+08 Merger + Event-Driven (Rec #16)
- **Amendment R3.1:** T1.4 merged 4 agents (113→108) · Room 08 (Data) merged into Room 04 (15→14) · Stack Lock: Frontend=React EXCLUSIVE · Backend=Laravel 11+ EXCLUSIVE · Mobile=Flutter 3.22+/Dart 3+ EXCLUSIVE · All human-time concepts removed from agent mandates.
