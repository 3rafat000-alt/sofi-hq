...
| --- | --- | --- |  
| Named slot  | Sidebar + main content  |  
| Intercept same level  | Preview sibling route in a modal  |  
| Intercept parent  | Open a child of the parent as an overlay  |  
| Intercept two levels  | Deeply nested overlay  |  
| Intercept from root  | Show arbitrary route in current view  |  
...
|  `.jpg` `.jpeg` `.png`  | Apple App Icon file  |  
...
| `.xml`  | Sitemap file  |  
| --- | --- |  
|  `.js` `.ts`  | Generated Sitemap  |  
| `.txt`  | Robots file  |  
|  `.js` `.ts`  | Generated Robots file  |  
...
[Edit this page on GitHub ](https://github.com/vercel/next.js/edit/canary/docs/01-app/01-getting-started/02-project-structure.mdx)Scroll to top 
Was this helpful?

> ⚠️ **Tables broken by scraping (INT-GTW-025):** missing columns in the tables of this raw reference — read with care until it is re-harvested.
