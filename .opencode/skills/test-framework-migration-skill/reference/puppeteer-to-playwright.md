...
- Playwright: CDP to `wss://cdp.lambdatest.com/playwright?capabilities=...`. See [playwright-skill/reference/cloud-integration.md](../../playwright-skill/reference/cloud-integration.md) and.
